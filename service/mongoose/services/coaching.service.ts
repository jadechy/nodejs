...
export class CoachingService{
    ...
    constructor(public readonly connection: Mongoose) {
        this.coachingModel = connection.models.Coaching || connection.model('Coaching', coachingSchema());
    }
    ...
    async updateCoaching(coachingId: string, updateData: UpdateCoaching): Promise<Coaching> {
    ...
    async joinCoaching(coachingId: string, userId: string): Promise<Coaching> {
        ...
        const updatedCoaching = await this.coachingModel.findByIdAndUpdate(
            coachingId,
