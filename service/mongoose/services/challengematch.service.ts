...
export class ChallengeMatchService {
  ...
  async createChallengeMatch(
    challengeMatch: CreateChallengeMatch
  ): Promise<ChallengeMatch> {
    const challengeId =
      typeof challengeMatch.challenge === "string"
        ? new Types.ObjectId(challengeMatch.challenge)
        : new Types.ObjectId(challengeMatch.challenge._id);
    const challengerId =
      typeof challengeMatch.challenger === "string"
        ? new Types.ObjectId(challengeMatch.challenger)
        : new Types.ObjectId(challengeMatch.challenger._id);
    const opponentId =
      typeof challengeMatch.opponent === "string"
        ? new Types.ObjectId(challengeMatch.opponent)
        : new Types.ObjectId(challengeMatch.opponent._id);
