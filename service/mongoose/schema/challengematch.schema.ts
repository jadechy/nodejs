...
export function challengeMatchSchema(): Schema<ChallengeMatch> {
    return new Schema<ChallengeMatch>({
        ...
        challengerTraining: { type: Types.ObjectId, ref: 'Training', required: false  },
        opponentTraining: { type: Types.ObjectId, ref: 'Training', required: false  },
        status: {
            type: String,
            required: true,
